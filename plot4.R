...
with(reqdData,plot(Time,Global_active_power,type="l",xlab="",ylab = "Global Active Power",xaxt="n"))
#Creating X axis
...
#4th plot:
#Plot the graph without x axis
with(reqdData,plot(Time,Global_reactive_power,type="l",xlab="",ylab = "Global Active Power",xaxt="n"))
axis(side=1,at=c(1170268200,1170354600,1170440940),labels = c("Thu","Fri","Sat"))
